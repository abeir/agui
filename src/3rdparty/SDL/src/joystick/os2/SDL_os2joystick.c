...
/* This should fill the nbuttons and naxes fields of the joystick structures.	*/
/* It returns 0, or -1 if there is an error.												*/
/******************************************************************************/
static int OS2_JoystickOpen(SDL_Joystick *joystick, int device_index)
{
	int index;		/* Index shortcut for index in joystick structures */
...
/* This function shouldn't update the joystick structures directly,			*/
...
static void OS2_JoystickUpdate(SDL_Joystick *joystick)
{
	...
	struct _transaxes *transaxes;			/* Shortcut for Correction structures */
