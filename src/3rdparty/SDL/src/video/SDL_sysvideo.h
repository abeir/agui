...
/* Define the SDL window-shaper structures */
...
/* Define the SDL shape driver structures */
...
/* Define the SDL window structures, corresponding to toplevel windows */
struct SDL_Window
{
    const void *magic;
    Uint32 id;
...
/*
 * Define the SDL display structures.
...
/* Define the SDL video driver structures */
...
struct SDL_VideoDevice
{
    ...
    /* * * */
    /* The function used to dispose of this structures */
    void (*free) (_THIS);
};
