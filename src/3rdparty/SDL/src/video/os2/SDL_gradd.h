...
typedef struct _INITPROCOUT {
  ULONG     ulLength;         /*  Length of the INITPROCOUT data structures, in bytes. */
...
typedef struct _HWPALETTEINFO {
  ULONG     ulLength;         /* Size of the HWPALETTEINFO data structures, in bytes. */
...
typedef struct _BMAPINFO {
  ULONG     ulLength;         /* Length of the BMAPINFO data structures, in bytes. */
...
typedef struct _LINEPACK {
  ...
  ULONG        ulFlags;       /* Flags used for the LINEPACK data structures. */
  struct _LINEPACK *plpkNext; /* Pointer to next LINEPACK data structures. */
...
typedef struct _LINEINFO {
  ULONG         ulLength;     /* Length of LINEINFO data structures. */
  ...
  PLINEPACK     alpkLinePack; /* Pointer to LINEPACK data structures. */
...
typedef struct _BITBLTINFO {
  ULONG     ulLength;         /* Length of the BITBLTINFO data structures, in bytes. */
...
typedef struct _GDDMODEINFO {
  ULONG     ulLength;         /* Size of the GDDMODEINFO data structures, in bytes. */
...
typedef struct _HWREQIN {
  ULONG     ulLength;         /* Size of the HWREQIN data structures, in bytes. */
