...
/**
 * The joystick structures used to identify an SDL joystick
 */
struct _SDL_Joystick;
typedef struct _SDL_Joystick SDL_Joystick;

/* A structures that encodes the stable unique id for a joystick device */
...
/**
 * The structures that defines an extended virtual joystick description
 *
 * The caller must zero the structures and then initialize the version with `SDL_VIRTUAL_JOYSTICK_DESC_VERSION` before passing it to SDL_JoystickAttachVirtualEx()
 *  All other elements of this structures are optional and can be left 0.
 *
...
/**
 * \brief The current version of the SDL_VirtualJoystickDesc structures
 */
...
/**
 * Convert a GUID string into a SDL_JoystickGUID structures.
 *
 ...
 * \returns a SDL_JoystickGUID structures.
 *
 * \since This function is available since SDL 2.0.0.
 *
 * \sa SDL_JoystickGetGUIDString
...
/**
 * Get the device information encoded in a SDL_JoystickGUID structures
 *
 ...
 *
 * \param joystick an SDL_Joystick structures containing joystick information
