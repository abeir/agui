...
/**
 *  \brief  The structures that defines a display mode
 *
 ...
 * \param rect the SDL_Rect structures filled in with the display bounds
 * \returns 0 on success or a negative error code on failure; call
 *          SDL_GetError() for more information.
 *
 * \since This function is available since SDL 2.0.0.
 ...
 * \param mode an SDL_DisplayMode structures filled in with the mode at
 *             `modeIndex`
 * \returns 0 on success or a negative error code on failure; call
 *          SDL_GetError() for more information.
 *
 ...
 *
 * \param displayIndex the index of the display to query
 * \param mode an SDL_DisplayMode structures filled in with the current display
 *             mode
 * \returns 0 on success or a negative error code on failure; call
 *          SDL_GetError() for more information.
 *
 ...
 *
 * \param displayIndex the index of the display to query
 * \param mode an SDL_DisplayMode structures containing the desired display
 *             mode
 * \param closest an SDL_DisplayMode structures filled in with the closest
 ...
 * \param mode the SDL_DisplayMode structures representing the mode to use, or
 ...
 *
 * \param window the window to query
 * \param mode an SDL_DisplayMode structures filled in with the fullscreen
 *             display mode
 * \returns 0 on success or a negative error code on failure; call
 *          SDL_GetError() for more information.
 *
 ...
 *
 * \param window the window to change
 * \param icon an SDL_Surface structures containing the icon for the window
 *
 * \since This function is available since SDL 2.0.0.
 */
