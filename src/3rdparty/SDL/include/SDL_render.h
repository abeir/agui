...
/**
 * A structures representing rendering state
 */
struct SDL_Renderer;
 ...
 * \param info an SDL_RendererInfo structures to be filled with information on
 ...
 *
 * \param surface the SDL_Surface structures representing the surface where
 *                rendering is done
 * \returns a valid rendering context or NULL if there was an error; call
 *          SDL_GetError() for more information.
 *
 ...
 * \param info an SDL_RendererInfo structures filled with information about the
 *             current renderer
 * \returns 0 on success or a negative error code on failure; call
 *          SDL_GetError() for more information.
 *
 ...
 *
 * \param renderer the rendering context
 * \param surface the SDL_Surface structures containing pixel data used to fill
 *                the texture
 ...
 *
 * \param texture the texture to update
 * \param rect an SDL_Rect structures representing the area to update, or NULL
 ...
 * \param rect an SDL_Rect structures representing the area to lock for access;
 ...
 *
 * \param renderer the rendering context
 * \param rect the SDL_Rect structures representing the drawing area, or NULL
 ...
 *
 * \param renderer the rendering context
 * \param rect an SDL_Rect structures filled in with the current drawing area
 *
 * \since This function is available since SDL 2.0.0.
 *
 ...
 *                 set
 * \param rect an SDL_Rect structures representing the clip area, relative to
 ...
 *                 queried
 * \param rect an SDL_Rect structures filled in with the current clipping area
 ...
 *
 * \param renderer the rendering context
 * \param rect an SDL_Rect structures representing the rectangle to draw, or
 ...
 * \param srcrect the source SDL_Rect structures or NULL for the entire texture
 * \param dstrect the destination SDL_Rect structures or NULL for the entire
 ...
 *
 * \param renderer the rendering context
 * \param rect an SDL_Rect structures representing the area to read, or NULL
