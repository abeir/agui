...
/**
 * This is the read/write operation structures -- very basic.
 */
typedef struct SDL_RWops
{
    ...
    /**
     *  Close and free an allocated SDL_RWops structures.
     *
...
/**
 * Use this function to create a new SDL_RWops structures for reading from
 ...
 *             the file.
 * \returns a pointer to the SDL_RWops structures that is created, or NULL on
...
/**
 * Use this function to create an SDL_RWops structures from a standard I/O file
 ...
 * \returns a pointer to a new SDL_RWops structures, or NULL if it fails; call
...
/**
 * Use this function to allocate an empty, unpopulated SDL_RWops structures.
 *
...
/**
 * Use this function to free an SDL_RWops structures allocated by
 * SDL_AllocRW().
 *
 * Applications do not need to use this function unless they are providing
 * their own SDL_RWops implementation. If you just need a SDL_RWops to
 ...
 *
 * \param area the SDL_RWops structures to be freed
 *
 * \since This function is available since SDL 2.0.0.
 *
 * \sa SDL_AllocRW
 ...
 * Prior to SDL 2.0.10, this function was a macro.
 *
 * \param context a pointer to an SDL_RWops structures
 ...
 * Prior to SDL 2.0.10, this function was a macro.
 *
 * \param context SDL_RWops structures to close
