...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        // will be passed to the rendering backend via the ImDrawCmd structures.
    ...
    if (ImGui::TreeNode("Plotting"))
    {
        ...
        // Tip: If your float aren't contiguous but part of a structures, you can pass a pointer to your first float
        // and the sizeof() of your structures in the "stride" parameter.
...
// Dummy data structures that we use for the Table demo.
// (pre-C++11 doesn't allow us to instantiate ImVector<MyItem> template if this structures is defined inside the demo function)
namespace
{
...
static void ShowDemoWindowTables()
{
    ...
    // There are however a few settings that a shared and part of the ImGuiStyle structures:
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    // You can pass in a reference ImGuiStyle structures to compare to, revert to and save to
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            HelpMarker(
                ...
                "rebuild the font atlas, and call style.ScaleAllSizes() on a reference ImGuiStyle structures.\n"
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        if (ImGui::BeginChild("ScrollingRegion", ImVec2(0, -footer_height_to_reserve), false, ImGuiWindowFlags_HorizontalScrollbar))
        {
            ...
            for (int i = 0; i < Items.Size; i++)
            {
                ...
                // (e.g. make Items[] an array of structures, store color/type etc.)
                ImVec4 color;
...
// Simplified structures to mimic a Document model
struct MyDocument
{
